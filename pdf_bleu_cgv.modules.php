 ...
 * Copyright (C) 2024      Patrick Rauch      	<patrick@formaction.fr>
 *
...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_bleu_cgv.modules.php
 *	\ingroup    propale
 *	\brief      File of Class to generate PDF proposal with Bleu CGV template
 */
...
/**
 *	Class to generate PDF proposal Bleu CGV
 */
class pdf_bleu_cgv extends ModelePDFPropales
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "bleu_cgv";
		$this->description = "Modèle de proposition commerciale avec CGV";
