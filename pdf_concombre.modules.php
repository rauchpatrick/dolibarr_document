...
/**
 *  \file       htdocs/core/modules/facture/doc/pdf_concombre.modules.php
 *  \ingroup    facture
 *  \brief      File of class to generate customers invoices from concombre model
 */
...
/**
 *	Class to manage PDF invoice template concombre
 */
class pdf_concombre extends ModelePDFFactures
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "concombre";
		$this->description = "Modèle de facture basé sur Sponge et intégrant les CGV";
